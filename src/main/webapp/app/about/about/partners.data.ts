...
export const PARTNERS: Partner[] = [
  ...
  { code: 'CEBC', name: "Centre d'Etudes Biologiques de Chizé", location: 'France', url: 'https://www.cebc.cnrs.fr/' },
  { code: 'CEFE', name: "Centre d'Ecologie Fonctionnelle et Evolutive", location: 'France', url: 'https://www.cefe.cnrs.fr/' },
  { code: 'CNRS', name: 'Centre national de la recherche scientifique', location: 'France', url: 'https://www.cnrs.fr/fr' },
  ...
  { code: 'MARBEC', name: 'Marine Biodiversity Exploitation and Conservation', location: 'France', url: 'https://umr-marbec.fr/' },
